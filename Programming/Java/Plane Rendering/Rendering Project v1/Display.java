...
public class Display extends SaccoObject
{
    ...
    {            
        ...
        wGen.genDesert(scale);
        terrTiles = wGen.getTerrain();
    ...
    public void paintWindow(PaintBrush brush)
    {
        ...
        for (int i = 0; i < xCords.length - 1; i++)
        {
            ...
            for (int n = 0; n < yCords.length - 1; n++)
            {
                ...
                int p1yPlus = (int)(useVdeg * (double)terrTiles[iIndex][nIndex].getHeight() );
                int p2yPlus = (int)(useVdeg * (double)terrTiles[iIndex+1][nIndex].getHeight() );
                int p3yPlus = (int)(useVdeg * (double)terrTiles[iIndex][nIndex+1].getHeight() );                
                int p4yPlus = (int)(useVdeg * (double)terrTiles[iIndex+1][nIndex+1].getHeight() );
                ...
                brush.setColor(terrTiles[i][n].getColor());
        ...
        {
            brush.setColor("black");
            brush.drawLine(xCords[i][0],yCords[i][0],xCords[i][scale-1],yCords[i][scale-1]);
            brush.drawLine(xCords[0][i],yCords[0][i],xCords[scale-1][i],yCords[scale-1][i]);
        }
    }
...
int p1yPlus = (int)(useVdeg * (double)terrTiles[i][n] );
int p2yPlus = (int)(useVdeg * (double)terrTiles[i+1][n] );
int p3yPlus = (int)(useVdeg * (double)terrTiles[i][n+1] );                
int p4yPlus = (int)(useVdeg * (double)terrTiles[i+1][n+1] );
...
{
int p1yPlus = (int)(useVdeg * (double)terrTiles[i][n] );
int p2yPlus = (int)(useVdeg * (double)terrTiles[i][n+1] );
