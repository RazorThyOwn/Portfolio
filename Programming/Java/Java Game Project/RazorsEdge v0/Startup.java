...
public class Startup
{
    ...
    public static void main()
    {
        ...
        sightRange = (worldGen.getSightRange());
    ...
    {       
        ...
        { 
            Player newPlayer = new Player(i,diff);
            ...
            newPlayer.cUpdate();
            newPlayer = addBasic(newPlayer);
            playerList[i]=newPlayer;
        }
        Player[] newPlayerList = contestMode();
        playerList = newPlayerList;
        playerCordsInit();
        iS = new Controller(playerList,mapSize,terrain,sightRange,importer);
        iS.launch();
    }
    ...
    public void pollInput()
    {
        ...
        for (int i = 0; i < playerList.length; i++)
        {
            ...
            Player tmpPlayer = new Player(i,diff);
    ...
    {
        System.out.println("Adding basics to "+inP.getName());
        ...
        int aSize = importer.getAAr().length - 1;
        int rMath1 = (int)((Math.random())*size);
        int rMath2 = (int)((Math.random())*size);
        int rMath3 = (int)( (Math.random())*aSize);

        inP.addWeapon(importer.getWAr()[rMath1]);
        inP.addWeapon(importer.getWAr()[rMath2]);
        inP.addApparel(importer.getAAr()[rMath3]);
    ...
    public static void testLaunch()
    {
        ...
        Player p1 = new Player(0,diff);
        p1.setName("Alex");
        //p1.setClassName("Warrior-Tank");

        Player p2 = new Player(1,diff);
        p2.setName("Max");
        //p2.setClassName("Ninja-Scientist");

        Player p3 = new Player(2,diff);
        p3.setName("Jake");
        //p3.setClassName("Ninja-Warrior");

        Player p4 = new Player(3,diff);
        p4.setName("Drew");
        //p4.setClassName("Gazelle-Tank");

        Player p5 = new Player(4,diff);
        p5.setName("Angela");

        Player p6 = new Player(5,diff);
        p6.setName("Dylan");

        Player p7 = new Player(6,diff);
        p7.setName("Drake");

        Player p8 = new Player(7,diff);
        p8.setName("Julian");

        Player p9 = new Player(8,diff);
        p9.setName("Alyza");

        Player p10 = new Player(9,diff);
        p10.setName("Jessica");

        Player p11 = new Player(10,diff);
        p11.setName("Romeo");
        ...
        for (int i = 0; i <playerListX.length; i++)
        {
            ...
            for (int k = 0; k < 5; k++)
            {
                int rMath = 10 - (int)(Math.random()*20);
                tmpPlayer.setVal(k,10+rMath);
                if (k==2)
                {
                    System.out.println(tmpPlayer.getVal(2));
                }
            }
        ...
        WorldGenerator worldGen = new WorldGenerator();
        terrain = worldGen.worldGen(5,500,playerListX.length);
        sightRange = worldGen.getSightRange();

        Controller cO = new Controller(playerListX,500,terrain,sightRange,importer);
        cO.launch();
    }

    public static void jakeVAlex()
    {
        Player[] playerListX = new Player[3];
        ...
        for (int i = 0; i <playerListX.length; i++)
        {
            Player tmpPlayer = playerListX[i];            
            tmpPlayer.setName(playerListX[i].getName());
            for (int k = 0; k < 5; k++)
            {
                int charT = 10;
        ...
        WorldGenerator worldGen = new WorldGenerator();
        terrain = worldGen.worldGen(-1,500,playerListX.length);
        sightRange = worldGen.getSightRange();
